...
public class PokemonEditor : Editor 
{
    public override void OnInspectorGUI()
    {
       ...
       /* data.editor_is_fold_open = EditorGUILayout.Foldout(data.editor_is_fold_open, "Pokemon data");
        ...
        if (data.editor_is_fold_open)
        {
            ...
            training_data.editor_is_open = EditorGUILayout.Foldout(training_data.editor_is_open, "Training data");
            ...
            breeding_data.editor_is_open = EditorGUILayout.Foldout(breeding_data.editor_is_open, "Breeding data");
            ...
            if (breeding_data.editor_is_open)
            {
                ...
                EditorGUILayout.TextField("Pokemon egg cycle", $"Between {breeding_data.egg_cycles[0]} and {breeding_data.egg_cycles[1]} steps!");
            ...
            base_stats.editor_is_open = EditorGUILayout.Foldout(base_stats.editor_is_open, "Breeding data");
        ...
        /*EditorGUILayout.IntField("Pokemon Level", pokemon.level);

        EditorGUILayout.Space();

        EditorGUILayout.IntField("Pokemon HP stat", pokemon.hp_stat);
        EditorGUILayout.IntField("Pokemon Attack stat", pokemon.attack_stat);
        EditorGUILayout.IntField("Pokemon Defense stat", pokemon.defense_stat);
        EditorGUILayout.IntField("Pokemon Sp.Attack stat", pokemon.spattack_stat);
        EditorGUILayout.IntField("Pokemon Sp.Defense stat", pokemon.spdefense_stat);
        EditorGUILayout.IntField("Pokemon Speed", pokemon.speed_stat);
